<template>
  <a-drawer
    ...
    <div class="copyer-editor-tab-wrapper">
      ...
      <!-- 设置表单权限 -->
      <NodeFormAuthSetting v-model:flowNodeConfig="flowNodeConfig" :editable="false" v-else-if="viewEditorType == 1"></NodeFormAuthSetting>
    </div>
