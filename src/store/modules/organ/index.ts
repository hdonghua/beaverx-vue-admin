...
/** 默认的空白项（用于找不到时的返回值） */
const createDefaultDept = (deptId: number): DeptItem => ({ id: deptId, name: "" });
const createDefaultRole = (roleId: number): RoleItem => ({ id: roleId, name: "" });
