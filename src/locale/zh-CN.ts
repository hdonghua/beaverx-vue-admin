...
export default {
  ...
  'menu.components': '组件概览',
  'menu.components.overview': '概览',
  'menu.components.dictSelect': '字典选择',
  'menu.components.dictTag': '字典标签',
  'menu.components.svgIcon': 'SVG 图标',
  'menu.components.richText': '富文本',
  'menu.components.signaturePad': '签名板',
  'menu.components.backToTop': '回到顶部',
  'menu.components.editableText': '可编辑文本',
  'menu.components.rollLoading': '滚动加载',
  'menu.components.loadingLayer': '加载遮罩',
  'menu.components.permission': '权限指令',
